scrumapp.views["table"] = {
	...
	initEvents: function(){
		addEventListener("touchstart", this.doTouchStart, false);
		addEventListener("mousedown", this.doTouchStart, false);
	},
	initCanvas: function(){	
		c = document.getElementById('tablecanvas');
		ctx = c.getContext('2d');
		ctx.font = this.fontSize+'pt '+'biko';
